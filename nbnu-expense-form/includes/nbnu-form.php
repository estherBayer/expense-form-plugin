...
<div class="nbnu-form-container">
    ...
    <form id="nbnu-expense-form" enctype="multipart/form-data">
        <div class="nbnu-form-section">
            ...
            <div class="nbnu-personal-info">
                <div class="nbnu-input-group">
                    ...
                    <input type="text" id="form_hourly_rate" name="form_hourly_rate" class="nbnu-form-input" placeholder="<?php echo esc_attr__( '$0.00', 'nbnu-expense-form' ); ?>" required>
                </div>
                <div class="nbnu-input-group">
        ...
        <div class="nbnu-form-grid">
            ...
            <?php foreach ( $day_keys as $day_key ) : ?>
                <div class="nbnu-grid-item">
                    <input type="number" step="0.25" class="nbnu-form-input nbnu-travel-hours nbnu-hidden" id="form_<?php echo esc_attr( $day_key ); ?>_hours_travel" name="form_<?php echo esc_attr( $day_key ); ?>_hours_travel">
                </div>
            <?php endforeach; ?>
            <div class="nbnu-grid-item nbnu-grid-item-header nbnu-grid-span-2">
            ...
            <?php foreach ( $day_keys as $day_key ) : ?>
                <div class="nbnu-grid-item">
                    <input type="number" step="0.25" class="nbnu-form-input nbnu-meeting-hours nbnu-hidden" id="form_<?php echo esc_attr( $day_key ); ?>_hours_meeting" name="form_<?php echo esc_attr( $day_key ); ?>_hours_meeting">
                </div>
            <?php endforeach; ?>
            <div class="nbnu-grid-item nbnu-grid-item-header nbnu-grid-span-2">
                ...
                <?php foreach ( $day_keys as $day_key ) : ?>
                    <div class="nbnu-grid-item">
                        <div class="nbnu-km-input-wrapper">
                            ...
                            <input type="number" class="nbnu-form-input nbnu-km-manual nbnu-hidden" id="form_<?php echo esc_attr( $day_key ); ?>_kms_manual" name="form_<?php echo esc_attr( $day_key ); ?>_kms_manual" placeholder="<?php esc_attr_e( 'Enter KM', 'nbnu-expense-form' ); ?>">
        ...
        <div class="nbnu-form-actions">
            <button type="submit" id="nbnu-form-submit" class="nbnu-form-submit button button-primary"><?php esc_html_e( 'Submit', 'nbnu-expense-form' ); ?></button>
