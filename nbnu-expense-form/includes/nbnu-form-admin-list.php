        ...
        <table class="wp-list-table widefat fixed striped">
            <thead>
                <tr>
                    ...
                    <th><?php esc_html_e( 'Submission #', 'nbnu-expense-form' ); ?></th>
            ...
            <tbody>
                <?php foreach ( $submissions as $submission ) :
                    ...
                    <tr>
                        ...
                        <td><?php echo esc_html( $submission['submission_number'] ?: $submission_id ); ?></td>
                        ...
                        <td><?php echo esc_html( $total_amount ? nbnu_expense_format_currency( $total_amount ) : __( '$0.00', 'nbnu-expense-form' ) ); ?></td>
                        <td>
                        ...
                        <td>
                            <a href="<?php echo esc_url( admin_url( 'admin.php?page=nbnu-expense-admin&view=submission&id=' . $submission_id ) ); ?>"
                               class="button button-small"><?php esc_html_e( 'View / Edit', 'nbnu-expense-form' ); ?></a>
                            <a href="<?php echo esc_url( admin_url( 'admin.php?page=nbnu-expense-admin&view=submission&id=' . $submission_id . '&format=print' ) ); ?>"
                               class="button button-small" target="_blank" rel="noopener noreferrer"><?php esc_html_e( 'Print / PDF', 'nbnu-expense-form' ); ?></a>
                        </td>
                    </tr>
                <?php endforeach; ?>
            </tbody>
